...
describe(`API returns category list`, () => {
  ...
  test(`Category names are "Книги", "Разное", "Посуда", "Игры", "Животные", "Журналы", "Личное", "Хлам"`,
      () => expect(response.body).toEqual(
          expect.arrayContaining([`Книги`, `Разное`, `Посуда`, `Игры`, `Животные`, `Журналы`, `Личное`, `Хлам`])
      )
  );
});
